                ...
                child: Column(
                  ...
                  children: [
                    ...
                    EditUserTextField(
                      ...
                      data: data,
                      validator: (p0) => p0!.isEmpty ? 'Please enter your first name' : null,
                      mapKey: 'firstname',
                    ),
                    ...
                    EditUserTextField(
                      ...
                      keyboardType: TextInputType.name,
                      data: data,
                      validator: (p0) => p0!.isEmpty ? 'Please enter your last name' : null,
                      mapKey: 'lastname',
                    ),
                    ...
                    EditUserTextField(
                      ...
                      data: data,
                      validator: (p0) => p0!.isEmpty && p0.length < 8 ? 'Please enter your phone number' : null,
                      mapKey: 'phone',
                    ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          context.read<UserBloc>().add(UserEvent.updateUser(data));
                        }
                      },
                      style: ButtonStyle(
...
class TextFieldTitle extends StatelessWidget {
  const TextFieldTitle({super.key, required this.title, this.padding = 6});
  final String title;
...
class EditUserTextField extends StatelessWidget {
  const EditUserTextField({super.key, this.initialValue, required this.keyboardType, this.data, this.validator, this.mapKey, this.hintText});
...
class PasswordTextField extends StatelessWidget {
  const PasswordTextField({super.key, this.initialValue, this.data, this.validator, this.mapKey, this.hintText});
  final String? initialValue;
  final String? hintText;
  final Map<String, dynamic>? data;
  final String? Function(String?)? validator;
